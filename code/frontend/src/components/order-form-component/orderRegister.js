        ...
        <form onSubmit={processOrderFormHandler} className='form-stylings'>
                ...
                <div className="input-columns">
                    ...
                    <div className="input-container">
                        ...
                        <input value={orderDetails.senderPostalCode} name="senderPostalCode" onChange={processOrderInputHandler} type="text"className='order-reg-input-field' pattern='[0-9]{5}'></input>
                    </div>
                    ...
                    <div className="input-container">
                        ...
                        <input value={orderDetails.senderEmail} name="senderEmail" onChange={processOrderInputHandler} type="emai" className='order-reg-input-field'required></input>
                    </div>

                    <div className="input-container">
                        <label className="order-reg-label">Parcel Weight (g)</label>
                    ...
                    <div className="input-container">
                        <label className="order-reg-label">Delivery Fee (RS)</label>
                ...
                <div className="input-columns">
                    ...
                    <div className="input-container">
                        <label className="order-reg-label">Postal Code</label>
                        <input value={orderDetails.recipientPostalCode} name="recipientPostalCode" onChange={processOrderInputHandler} type="text" className='order-reg-input-field' pattern='[0-9]{5}'></input>
                    </div>
